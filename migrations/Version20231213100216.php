 ...
 */
final class Version20231213100216 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, name, slug, description, more_description, additional_infos, stock, solde_price, regular_price, images_urls, brand, is_available, is_best_seller, is_new_arrival, is_featured, is_special_offer FROM product');
