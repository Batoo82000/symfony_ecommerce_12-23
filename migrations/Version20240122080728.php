 ...
 */
final class Version20240122080728 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__collections AS SELECT id, title, description, button_text, button_link, image_url, created_at, updated_at FROM collections');
        ...
        $this->addSql('INSERT INTO collections (id, title, description, button_text, button_link, image_url, created_at, updated_at) SELECT id, title, description, button_text, button_link, image_url, created_at, updated_at FROM __temp__collections');
